      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <p className="text-muted-foreground mb-4 leading-relaxed">
              I believe in doing the job right the first time, being upfront
              about costs, and treating every home with respect. No job is too
              small, and I'm always happy to answer questions or give advice -
              even if it saves you a service call!
            </p>
            <p className="text-muted-foreground leading-relaxed">
              When I'm not fixing pipes, you'll find me coaching little league
              or spending time with family. I love being part of this community.
            </p>
          </div>
          <div className="group relative rounded-3xl overflow-hidden shadow-xl bg-card/40 ring-1 ring-border/60 transition-transform duration-300 hover:scale-[1.02]">
            <img
              src="/joe.png"
              alt="Professional plumber"
              className="w-full h-[420px] md:h-[520px] object-contain transition-transform duration-300 group-hover:scale-[1.01]"
            />
          </div>
        </div>
